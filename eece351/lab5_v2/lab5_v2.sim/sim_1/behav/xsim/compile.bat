...
REM
REM Generated by Vivado on Mon Oct 06 18:19:43 -0400 2025
...
echo "xvhdl --incr --relax -prj detect_11010_tb_vhdl.prj"
call xvhdl  --incr --relax -prj detect_11010_tb_vhdl.prj -log xvhdl.log
