...
REM
REM Generated by Vivado on Fri Oct 31 12:36:54 -0400 2025
...
echo "xvhdl --incr --relax -prj synchronizer_tb_vhdl.prj"
call xvhdl  --incr --relax -prj synchronizer_tb_vhdl.prj -log xvhdl.log
