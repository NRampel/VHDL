...
REM
REM Generated by Vivado on Mon Oct 27 17:23:42 -0400 2025
...
echo "xvhdl --incr --relax -prj vending_machine_tb_vhdl.prj"
call xvhdl  --incr --relax -prj vending_machine_tb_vhdl.prj -log xvhdl.log
