...
REM
REM Generated by Vivado on Wed Oct 22 15:02:12 -0400 2025
...
echo "xvhdl --incr --relax -prj sqrt8i_tb_vhdl.prj"
call xvhdl  --incr --relax -prj sqrt8i_tb_vhdl.prj -log xvhdl.log
