...
REM
REM Generated by Vivado on Mon Nov 17 19:34:47 -0500 2025
...
echo "xvhdl --incr --relax -prj serial_rx_tb_vhdl.prj"
call xvhdl  --incr --relax -prj serial_rx_tb_vhdl.prj -log xvhdl.log
