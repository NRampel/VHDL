...
entity is_composite_tb is
end is_composite_tb;

architecture Behavioral of is_composite_tb is

    signal a_sig,b_sig,c_sig,d_sig: std_logic;
	   signal f_sig: std_logic;
	
	   component is_composite is
	   port(
		  a,b,c,d: in std_logic;
		  f: out std_logic
    	  );
	end component is_composite;
begin
    MUT1: is_composite port map( a => a_sig, b => b_sig, c => c_sig, d => d_sig, f => f_sig);
