...
HD_PWD='C:/Users/DasNiko/Documents/GitHub/VHDL/new_components/new_components.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pulse_stretcher.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pulse_stretcher.tcl
