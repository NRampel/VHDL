...
HD_PWD='C:/Users/DasNiko/Documents/GitHub/VHDL/new_components/new_components.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pulse_stretcher.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pulse_stretcher.tcl -notrace
